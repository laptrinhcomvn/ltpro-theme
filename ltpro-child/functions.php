...
function ltpro_taobao365_theme_scripts_styles(){
    ...
    wp_enqueue_style( 'ltpro-child-style', get_stylesheet_directory_uri() .'/css/main.css',array(),$ver);
    wp_enqueue_style( 'ltpro-child-responsive', get_stylesheet_directory_uri() .'/css/responsive.css',array(),$ver);

    //wp_enqueue_script("scrollmagic-js", "//cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.7/ScrollMagic.min.js", array(),'2.0.7',true);
    //wp_enqueue_script("ltpro-child-js", get_stylesheet_directory_uri()."/js/main.min.js",array(),$ver,true);
}
...
function ltpro_taobao365_theme_widgets_init() {
    ...
    register_sidebar(array(
        'name'          => __('Right sidebar', 'ltpro-child'),
        'id'            => 'right-sidebar',
        'description'   => __('Right sidebar wigets.', 'ltpro-child'),
